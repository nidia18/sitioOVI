...
if (ima[indexTag].length>0){$("#ardoraChecks").css("width","325");
...
if ((mp4[indexTag].length>0)||(ogv[indexTag].length>0)){$("#ardoraChecks").css("width","325px");var newDiv=$('<div id="videoForTag"></div>);');
...
if ((ima[indexTag].length==0)&&(mp4[indexTag].length==0)&&(ogv[indexTag].length==0)){$("#ardoraChecks").css("width", "550px");}
